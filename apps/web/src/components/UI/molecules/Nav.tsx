...
Nav.Items = ({
  ...
  return (
    <ul
      className={clsx(
        "bg-white absolute left-1/2 -translate-x-2/4 px-6 py-8 max-w-sm rounded-md w-[90%] z-[999] transition-[transform] ease-out duration-300 flex flex-col gap-4 text-center shadow-2xl",
